...
# 全局变量
CSV_OUT = "data/statistics_3_red_1_blue.csv"
...
# 打印结果
def print_result(a, b, c, x, count, ids):
    print("[" + str(a) + "][" + str(b) + "][" + str(c) + "]+[" + str(x) + "]: " + str(count) + " : " + ids)


if __name__ == '__main__':
    data = pd.read_csv(m.CSV_IN, encoding='utf-8', engine='python')
    arr = count_all(data)
    m.write_csv(CSV_OUT, arr, ["RED1", "RED2", "RED3", "BLUE", "OCCURRENCE", "ISSUE"])
